...
\newcommand{\logc}{\ensuremath{\log_{10} T_{\mathrm{c}}}} %log central temperature
\newcommand{\logtc}{\ensuremath{\log_{10} T}} % Log temperature
\newcommand{\rhoc}{\ensuremath{\rho_{\mathrm{c}}}} % Central density 
\newcommand{\logrhoc}{\ensuremath{\log \rho_{\mathrm{c}}}} % Log central density
\newcommand{\logrho}{\ensuremath{\log \rho}} % Log  density
\newcommand{\teff}{\ensuremath{T_{\mathrm{eff}}}} % Effective temperature 
\newcommand{\logteff}{\ensuremath{\log_{10} T_{\mathrm{eff}}}} % Log effective temperature
