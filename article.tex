...
We use the \textit{Modules for Experiments in Stellar Astrophysics}  \citep[\textsc{mesa};][]{mesa1} 
...
\software{MESA\footnote{http://mesastar.org} \citep{mesa1,mesa2,mesa3,mesa4},
          Astropy\footnote{http://www.astropy.org} \citep{astropy1,astropy2}}
